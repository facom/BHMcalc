...
exec("OBJECT_HASHABLES['hz']=dict(str_incrit_wd='%s',str_incrit_nr='%s',str_outcrit_wd='%s',str_outcrit_nr='%s',str_sys='%s',Extra1='%.4f',Extra2='%.4f')")
...
exec("OBJECT_PIPE['hz']=['star1','star2','planet','binary']")
exec("OBJECT_PIPE['rotation']=['star1','star2','binary']")
exec("OBJECT_PIPE['interaction']=['star1','star2','planet','binary','rotation','hz']")
