...
#
###############################################################
shell_exec(\"hostname > /tmp/host\");
shell_exec(\"md5sum /tmp/host | cut -f 1 -d ' ' > /tmp/md5\");
\$md5=substr(rtrim(shell_exec(\"cat /tmp/md5\")),0,6);
shell_exec(\"rm /tmp/host /tmp/md5\");
