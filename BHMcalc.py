...
def Run():
    ...
    plt.axhline(Pbin/1.0,linestyle='-',color='c',linewidth=2,label='1:1')
    plt.axhline(Pbin/1.5,linestyle='--',color='c',linewidth=2,label='3:2')
    plt.axhline(Pbin/2.0,linestyle='-.',color='c',linewidth=2,label='2:1')
    plt.xticks(fontsize=TICS_SIZE)
    plt.yticks(fontsize=TICS_SIZE)
    plt.legend(loc='best',prop=dict(size=LEGEND_SIZE))
